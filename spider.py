...
import obsear
url = 'https://car.autohome.com.cn/photo/31525/1/4087892.html#pvareaid=2042264' #url统一资源定位符
...
# <img id="img" src="//car2.autoimg.cn/cardfs/product/g10/M00/0C/6E/1024x0_1_q87_autohomecar__wKgH4FijtkSAd8ZvAAN9pa735R8368.jpg" onside="1" style="cursor: url(&quot;/images/next.cur&quot;), pointer;">
    img_url = obsear.findall(r'<img id="img" src="(.*?)"', html)[0] #获取图片url正则表达式
...
# var nexturl = '/photo/31525/1/4087890.html'
    nexturl = obsear.findall(r"var nexturl = '(.*?)'", html)[0]
    print nexturl
    if nexturl:
